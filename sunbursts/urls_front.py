...
from .views_front import ElementTableView, SurveyView, GraphListView, SurveyResponseView, ThankYouView
...
urlpatterns = [
    ...
    path('survey_response/<int:pk>/', SurveyResponseView.as_view(), name='survey_response'),
